...
user3 = User.create! :name => 'Robert Clark', :email => 'clark@example.com', :password => 'clark1', :password_confirmation => 'clark1'
...
cat5 = Category.create! :name => 'Restaurants', :description => 'Restaurants'
cat6 = Category.create! :name => 'Miscellaneous', :description => 'Miscellaneous'
